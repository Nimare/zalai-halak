...
export const metadata = {
  title: 'Képek és szakmai források | Zalai halak',
...
export default function SourcesPage() {
  return <>
    ...
    <header className="game-header wrap">
      ...
      <a className="back-link" href="/jatek"><ArrowLeft size={18} aria-hidden="true"/> Vissza a játékhoz</a>
    </header>
    <main id="forrasok" className="sources-page">
      <section className="sources-hero wrap">
        <p className="eyebrow"><span/> FORRÁSOK ÉS KÉPJEGYZÉK</p>
